...
const zhMessages = {
  ...
  agentPreviewShapePending: "这张缩略图还没有可定位的画布图片，后续执行故事会补齐输出形状。",
...
const enMessages: I18nMessages = {
  ...
  agentPreviewShapePending: "This thumbnail does not have a locatable canvas image yet; a later execution story will attach output shapes.",
